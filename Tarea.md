...
Las bondades del ajuste para _train_ es $0.5845296$ y para _test_ $0.5946924$. Su complejidad es de 18 variables. La fiabilidad del modelo es buena ya que la diferencia entre sus bondades es de sólo $
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4Mzc5NjI0MTgsLTU2MTYxMTEwOCwyMD
